...
public class LibrariesForAsoft extends AbstractExternalDependencyFactory {
    ...
    public static class ViewmodelLibraryAccessors extends SubDependencyFactory {
        ...
        public ViewmodelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for compose (tz.co.asoft:viewmodel-compose)
             * This dependency was declared in catalog asoft.toml
             */
            ...
            /**
             * Creates a dependency provider for coroutines (tz.co.asoft:viewmodel-coroutines)
             * This dependency was declared in catalog asoft.toml
             */
            public Provider<MinimalExternalModuleDependency> getCoroutines() { return create("viewmodel.coroutines"); }

            /**
             * Creates a dependency provider for react (tz.co.asoft:viewmodel-react)
             * This dependency was declared in catalog asoft.toml
             */
            public Provider<MinimalExternalModuleDependency> getReact() { return create("viewmodel.react"); }

            /**
             * Creates a dependency provider for test (tz.co.asoft:viewmodel-test)
             * This dependency was declared in catalog asoft.toml
             */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: root (2.0.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog asoft.toml
             */
